...
class CreateTrackingSessionsExport extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tracking_sessions_export', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tracking_sessions_export');
    }
}
